...
Fuenta canónica: pyproject.toml [project] version = "0.15.12"

Valida que estas 5 fuentes estén en 0.15.12:
  1. pyproject.toml
...
Uso:
  ...
  python scripts/check_version.py 0.15.12 # fuerza expected
