...
def build_executable():
    ...
    command = [
        ...
        # Hidden imports para Flet
        "--hidden-import", "flet",
        "--hidden-import", "flet.runtime",
        "--collect-all", "flet",  # Recolectar todo flet
        "--hidden-import", "PIL",
        ...
        # Backend v0.11.0 - Bloques y vocabulario
        ...
        # Hidden imports para CustomTkinter
...
def main():
    ...
    try:
        ...
        if verify_build():
            logger.info("Compilacion completada exitosamente.")
