**[Español](CODE_OF_CONDUCT.md) | [English](CODE_OF_CONDUCT_EN.md)**
...
Instancias de comportamiento abusivo, acosador o de otra manera inaceptable pueden ser reportadas contactando al equipo del proyecto en **cenf.arg@gmail.com**. Todas las quejas serán revisadas e investigadas y resultarán en una respuesta que se considere necesaria y apropiada a las circunstancias. El equipo del proyecto está obligado a mantener la confidencialidad con respecto al reportero de un incidente. Más detalles de políticas de aplicación específicas pueden ser publicados por separado.
...
Para preguntas o inquietudes sobre este Código de Conducta, contacta a:

- **Email:** cenf.arg@gmail.com
- **GitHub:** [CENFARG/Audio2Text](https://github.com/CENFARG/Audio2Text)
