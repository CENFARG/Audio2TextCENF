"""@File: audio2text/providers/nvidia_riva_provider.py
@Description: NVIDIA Riva transcription provider — gRPC-based ASR (cloud or local).
@Version: 0.16.0
...
class NvidiaRivaProvider(TranscriptionProvider):
