...
class TutorialManager:
    ...
    def _define_steps(self) -> List[Dict[str, Any]]:
        return [
            ...
            {
                "title": "Bloques de Procesamiento",
                "message": "Activa Extractor de Tareas, Resúmenes y Palabras Clave.\nProcesan tu transcripción automáticamente.",
                "target": "tab_settings_placeholder",
                "position": "bottom_dock",
                "tab": self.app.localization_manager.get_string("tab_settings")
            },
            {
                "title": "Correcciones de Vocabulario",
                "message": "Si el modelo entiende mal palabras (ej: CENF → zenf),\nagrégalo aquí para corregirlo automáticamente.",
                "target": "tab_settings_placeholder",
                "position": "bottom_dock",
                "tab": self.app.localization_manager.get_string("tab_settings")
            },
